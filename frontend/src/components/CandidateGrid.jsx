  ...
  if (isLoading) {
    return (
      <div className="py-16 text-center space-y-3">
        ...
        <p className="text-xs text-slate-400 font-medium">Fetching candidate profiles from backend...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="py-12 px-6 rounded-3xl bg-rose-500/10 border border-rose-500/20 text-center max-w-md mx-auto">
        ...
        <h3 className="text-base font-bold text-white mb-1">Failed to Load Candidate Grid</h3>
    ...
    return (
      <div className="py-16 px-6 text-center max-w-md mx-auto bg-slate-900/60 border border-slate-800 rounded-3xl backdrop-blur-md">
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          There are no candidate profiles matching your query.
        </p>
      </div>
    );
  }
